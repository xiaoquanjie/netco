...
inline void IocpService::Access::ExecOp(IocpService& service, IoServiceImpl* simpl, 
	Operation* op, s_uint32_t transbyte, bool ok) 
{
	CoEventTask* task = 0;
...
inline void IocpService::Access::ExecOp2(void* param) {
